 ...
 * `placeTooltip` below the element (above when there is no room), clamped
 * to the viewport, over every other layer (a modal's backdrop included: the
 * × of About carries a title too) and transparent to the pointer. Named
...
import { installTooltips, placeTooltip, type TooltipShown } from "./tooltip";
...
export function TooltipLayer() {
  ...
  useLayoutEffect(() => {
    ...
    box.style.left = "0px";
    box.style.top = "0px";
    const placed = placeTooltip(shown.anchor.getBoundingClientRect(), box.getBoundingClientRect(), {
