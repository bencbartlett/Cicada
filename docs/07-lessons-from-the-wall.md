...
| 6 | Boolean carve took ~half an hour and was the fragility epicenter; curved NURBS cutters froze for 30 minutes | Kernel mismatch: NURBS booleans for FDM-bound geometry | Explicit representations: mesh-destined work tessellates and uses Manifold booleans (watertight, parallel, seconds); B-rep booleans serve the CAD tier, behind the seam with a rescue hatch |
