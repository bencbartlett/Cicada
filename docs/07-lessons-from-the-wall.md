...
| 10 | Text glyphs and DimStyle fights; per-entity size overrides ignored | Doc-global styles leaking into procedural geometry | fonttools/freetype outlines; no ambient document state — everything is a typed input |
